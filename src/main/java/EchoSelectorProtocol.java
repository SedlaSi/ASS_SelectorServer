...
public class EchoSelectorProtocol implements TCPProtocol {
    private static ByteBuffer tag;
    private static ByteBuffer etOrutBuff;
    private static ByteBuffer eleteBuf;
    ...
    private static FileCacheProvider fileCacheProvider;
    ...
    public void handleRead(SelectionKey key) {
        ...
        try {
            ...
            if(((char)tag.array()[0]) == 'G'){
                ...
                if(new String(etOrutBuff.array()).equals("ET ")){ // RIGHT TAG ACQUIRED
                ...
                if(new String(etOrutBuff.array()).equals("UT ")){ // RIGHT TAG ACQUIRED
                ...
                if(new String(eleteBuf.array()).equals("ELETE ")){ // RIGHT TAG ACQUIRED
            ...
            try{
                ...
                byte [] msg = UNKNOWN_COMMAND_ERR.getBytes();
    ...
    public void handleAccept(SelectionKey key) {
        try {
            ...
            output.write(ByteBuffer.wrap(WELCOME_MSG.getBytes()));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
